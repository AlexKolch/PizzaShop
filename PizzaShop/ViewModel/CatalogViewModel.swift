...
final class CatalogViewModel: ObservableObject {
    ...
    var meatPizzas = [Product(id: "1", title: "Пицца Маргарита", imageUrl: "Margarita", price: 400, descript: "вкусная пицца"),
                      Product(id: "2", title: "Пицца Пепперони", imageUrl: "Пепперони", price: 450, descript: "вкусная пицца"),
    ...
    var vegetablesPizzas = [Product(id: "1", title: "Вегетарианская", imageUrl: "vegetable", price: 470, descript: "вкусная пицца"),
                            Product(id: "2", title: "Пицца с грибами", imageUrl: "Пицца с грибами", price: 350, descript: "вкусная пицца"),
